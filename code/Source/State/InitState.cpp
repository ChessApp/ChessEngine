...
namespace Chess
{
  namespace State
  {
    ...
    BaseState * InitState::execute ( )
    {
      ...
      Pieces * wn1 = new Chess::Knight ( "WN " ) ;
      wn1->setKing( wk ) ;
      whiteTurn_->setActivePiece( wn1 ) ;
      Pieces * wn2 = new Chess::Knight ( "WN " ) ;
      wn2->setKing( wk ) ;
      whiteTurn_->setActivePiece( wn2 ) ;
      Pieces * bn1 = new Chess::Knight ( "BN " ) ;
      bn1->setKing( bk ) ;
      blackTurn_->setActivePiece( bn1 ) ;
      Pieces * bn2 = new Chess::Knight ( "BN " ) ;
      bn2->setKing( bk ) ;
      blackTurn_->setActivePiece( bn2 ) ;
      Pieces * wp1 = new Chess::WhitePawn ( "WP " ) ;
      wp1->setKing( wk ) ;
      whiteTurn_->setActivePiece( wp1 ) ;
      Pieces * wp2 = new Chess::WhitePawn ( "WP " ) ;
      wp2->setKing( wk ) ;
      whiteTurn_->setActivePiece( wp2 ) ;
      Pieces * wp3 = new Chess::WhitePawn ( "WP " ) ;
      wp3->setKing( wk ) ;
      whiteTurn_->setActivePiece( wp3 ) ;
      Pieces * wp4 = new Chess::WhitePawn ( "WP " ) ;
      wp4->setKing( wk ) ;
      whiteTurn_->setActivePiece( wp4 ) ;
      Pieces * wp5 = new Chess::WhitePawn ( "WP " ) ;
      wp5->setKing( wk ) ;
      whiteTurn_->setActivePiece( wp5 ) ;
      Pieces * wp6 = new Chess::WhitePawn ( "WP " ) ;
      wp6->setKing( wk ) ;
      whiteTurn_->setActivePiece( wp6 ) ;
      Pieces * wp7 = new Chess::WhitePawn ( "WP " ) ;
      wp7->setKing( wk ) ;
      whiteTurn_->setActivePiece( wp7 ) ;
      Pieces * wp8 = new Chess::WhitePawn ( "WP " ) ;
      wp8->setKing( wk ) ;
      whiteTurn_->setActivePiece( wp8 ) ;
      Pieces * bp1 = new Chess::BlackPawn ( "BP " ) ;
      bp1->setKing( bk ) ;
      blackTurn_->setActivePiece( bp1 ) ;
      Pieces * bp2 = new Chess::BlackPawn ( "BP " ) ;
      bp2->setKing( bk ) ;
      blackTurn_->setActivePiece( bp2 ) ;
      Pieces * bp3 = new Chess::BlackPawn ( "BP " ) ;
      bp3->setKing( bk ) ;
      blackTurn_->setActivePiece( bp3 ) ;
      Pieces * bp4 = new Chess::BlackPawn ( "BP " ) ;
      bp4->setKing( bk ) ;
      blackTurn_->setActivePiece( bp4 ) ;
      Pieces * bp5 = new Chess::BlackPawn ( "BP " ) ;
      bp5->setKing( bk ) ;
      blackTurn_->setActivePiece( bp5 ) ;
      Pieces * bp6 = new Chess::BlackPawn ( "BP " ) ;
      bp6->setKing( bk ) ;
      blackTurn_->setActivePiece( bp6 ) ;
      Pieces * bp7 = new Chess::BlackPawn ( "BP " ) ;
      bp7->setKing( bk ) ;
      blackTurn_->setActivePiece( bp7 ) ;
      Pieces * bp8 = new Chess::BlackPawn ( "BP " ) ;
      bp8->setKing( bk ) ;
